...
union YYSTYPE
{
#line 16 "./files/simple_language.y"
...
#line 41 "./files/simple_language.y"
    { 
        printf("Assign %s = %d\n", (yyvsp[-2].str)->c_str(), (yyvsp[0].num)); 
        (yyval.num) = vars[*(yyvsp[-2].str)] = (yyvsp[0].num); 
        print_assignment(*(yyvsp[-2].str), (yyvsp[0].num));
        delete (yyvsp[-2].str);
    }
#line 1156 "y.tab.c"
    break;
...
#line 58 "./files/simple_language.y"
                                { 
        (yyval.num) = (yyvsp[-2].num) + (yyvsp[0].num); 
        print_expression((yyvsp[-2].num), '+', (yyvsp[0].num));
    }
#line 1184 "y.tab.c"
    break;
...
#line 66 "./files/simple_language.y"
                                { 
        (yyval.num) = (yyvsp[-2].num) * (yyvsp[0].num); 
        print_expression((yyvsp[-2].num), '*', (yyvsp[0].num));
    }
...
#line 70 "./files/simple_language.y"
                                { 
        (yyval.num) = (yyvsp[-2].num) / (yyvsp[0].num); 
        print_expression((yyvsp[-2].num), '/', (yyvsp[0].num));
    }
...
#line 76 "./files/simple_language.y"
